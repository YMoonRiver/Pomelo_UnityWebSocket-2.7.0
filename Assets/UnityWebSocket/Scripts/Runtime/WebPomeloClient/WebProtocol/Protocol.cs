...
namespace Pomelo.UnityWebSocketPomelo
{
    public class Protocol
    {
        ...
        private UnityWebSocketPomeloClient wpc;

        public UnityWebSocketPomeloClient getPomeloClient()
        {
            return this.wpc;
        }

        public Protocol(UnityWebSocketPomeloClient wpc, WebSocket socket)
        {
            this.wpc = wpc;
